...
output: 
  html_document:
    theme: cosmo
---
```{r voronoiportrait, cache=T, fig.width=1.5, fig.height=1.5, units="in",out.width=300, out.height=300, echo=FALSE}
...
(Maurer, Bennette, 2019 -- Accepted pending minor revision!)
